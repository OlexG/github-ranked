        ...
        <div className="md:w-1/2 w-full mx-1 md:mx-0 p-1">
          <div className="w-full border p-6 rounded shadow">
            <div className="flex md:flex-row flex-col gap-4">
              {loading
                ? (
                  <div className="animate-pulse w-24 h-24 rounded-full bg-gray-300">
                  </div>
                )
                : (
                  <img
              ...
              <div className="flex flex-col justify-center">
                <p className="text-lg font-light flex flex-row items-center gap-2">
                  {loading
                    ? (
                      <div className="animate-pulse w-24 h-4 rounded bg-gray-300">
                      </div>
                    )
                    : (
                      <>
                            ...
                            return acc +
                              Math.round(
                                ((curr as any).contributions.totalCount *
                                  ...
                                  Math.max(
                                    1,
                                    (curr as any).repository.pullRequests
                                      .totalCount,
                                  ),
                              );
                          }, 0)} pts
                ...
                {loading
                  ? (
                    <div className="animate-pulse w-48 h-8 rounded bg-gray-300 mt-4">
                    </div>
                  )
            ...
            {loading
              ? (
                <div className="animate-pulse w-48 h-4 rounded bg-gray-300 m-3">
                </div>
              )
              : (
                <p className="text-lg font-extralight p-3">
                  <span>{user.username}</span>'s top 10 repositories
                </p>
              )}
            {loading
              ? (
                <div className="animate-pulse w-full h-4 rounded bg-gray-300 m-3">
                </div>
              )
              : (
                <table class="table-auto min-w-full border text-left text-sm font-light">
                  <thead className="bg-gray-100">
                    <tr className="border-b">
                      <th className="font-bold md:p-4 p-1 text-green-400">
                        Name
                      </th>
                      <th className="font-bold md:p-4 p-1 border-l text-yellow-400 flex flex-row gap-1 items-center">
                        Stars
                      </th>
                      <th className="font-bold md:p-4 p-1 border-l text-purple-500">
                        Contributions
                      </th>
                    </tr>
                  </thead>
                        ...
                        <tr className="border-b">
                          <td className="font-bold md:p-4 p-1 text-green-400">
                            <a
                              ...
                              target="_blank"
                            >
                              <IconBook2 class="w-4 h-4" />{" "}
                              {repo.repository.name}
                            </a>
                          </td>
                          <td className="font-bold md:p-4 p-1 border-l text-yellow-400 flex flex-row gap-1 items-center">
                            {repo.repository.stargazerCount}{" "}
                            <IconStarFilled class="w-4 h-4" />
                          </td>
                          <td className="font-bold md:p-4 p-1 border-l text-purple-500">
                            <div className="flex flex-row gap-1 items-center">
                              <IconTrophyFilled class="w-4 h-4" />
