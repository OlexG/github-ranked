  ...
  return (
    <>
      ...
      <div class="flex flex-col items-center justify-center h-screen absolute top-0 right-0 w-screen -z-50">
        <div>
          <h1 class="text-6xl font-bold text-gray-500 px-4">Github Ranked</h1>
          <p class="text-lg font-light text-gray-500 px-4">Type a Github username is the searchbox above</p>
          <p className="font-light text-sm text-gray-500 lg:w-96 pt-2 px-4">
